...
if (isset($_POST['SeConnecter']))
		{
			...
			$unControleur->setTable("responsable");
			$champs = array("pseudo", "mdp", "nom", "prenom", "idResp" ); //la selection
			//var_dump($champs);
				...
				foreach ($resultat as $uneLigne)
					{
						...
						$_SESSION['idResp']=$uneLigne['idResp']; 
					}
					
					
					header('Location: index_resp.php?first=1');
					ob_end_flush();
			}
		}
?>
